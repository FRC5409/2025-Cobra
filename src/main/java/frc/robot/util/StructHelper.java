...
public class StructHelper {
     ...
     */
    public static <TYPE> void publishStruct(String name, Struct<TYPE> struct, Supplier<TYPE> value) {
        StructPublisher<TYPE> publisher = NetworkTableInstance.getDefault()
            .getStructTopic(name, struct).publish();
     ...
     * @param value The value of the struct
     */
    public static <TYPE> void publishStruct(String tabName, String name, Struct<TYPE> struct, Supplier<TYPE> value) {
        StructPublisher<TYPE> publisher = NetworkTableInstance.getDefault()
    ...
    /**
     * This method should only be called periodically ONCE. Do not call this method if you don't know what you are doing
     */
    ...
    private static <T> void updatePair(Pair<StructPublisher<?>, Supplier<?>> pair) {
